...
(function (global) {
    ...
    if (!TriangleMesh && typeof global !== 'undefined' && global.ContactThermo) {
        TriangleMesh = global.ContactThermo.TriangleMesh;
    }
    if (!MeshGeometricDerivative && typeof global !== 'undefined' && global.ContactThermo) {
    ...
    const MeshEntropicFlowModule = { EntropicMeshflow };

    // Export for different module systems
    if (typeof module !== 'undefined' && module.exports) {
        module.exports = MeshEntropicFlowModule;
    }
    if (typeof define === 'function' && define.amd) {
        define([], () => MeshEntropicFlowModule);
    }
    if (typeof global !== 'undefined') {
        global.ContactThermo = global.ContactThermo || {};
        Object.assign(global.ContactThermo, MeshEntropicFlowModule);
    }
